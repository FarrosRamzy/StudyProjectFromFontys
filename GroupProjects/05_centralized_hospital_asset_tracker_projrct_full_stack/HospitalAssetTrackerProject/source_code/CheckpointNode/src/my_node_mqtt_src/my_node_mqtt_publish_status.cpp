 ...
 * @return false
 */
bool MyNodeMQTT::publishHeartbeat(const char *hospital_id, const char *hospital_name, const char *device_id,
                                  const char *room_name, const char *timestamp)
{
    if (!hasRequiredText(hospital_id) || !hasRequiredText(device_id) || !hasRequiredText(timestamp))
    {
                                 ...
                                 const char *status, const char *timestamp)
{
    if (!hasRequiredText(hospital_id) || !hasRequiredText(device_id) ||
        !hasRequiredText(status) || !hasRequiredText(timestamp))
    {
